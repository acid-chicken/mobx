...
Because `observer` automatically tracks any observables that are used (and none
...
For more advantages of using observable local component state, for class based
components see
